...
with aba_radar:
    ...
    # Definição das listas (já limpando o .SA para o TradingView BMFBOVESPA)
    ...
    if btn_radar:
        # Define qual lista vai ser usada baseada na seleção
        ...
        st.markdown("---")
        # Cria a barra de progresso embutida com texto
        ...
        for idx, ativo in enumerate(lista_ativos):
            ...
            # Atualiza a barra de carregamento azul e o texto correndo junto
            ...
            try:
                ...
                pass # Ignora falhas de conexão em ativos específicos
            
            time.sleep(0.05) # Pausa mínima só para a animação da barra fluir bonita
